...
public class DatabaseLoader {
    ...
    private void initDatabase() throws IOException {
        ...
        Privilege p1 = new Privilege("logon","Ability to logon to the application");
        privilegeRepository.save(p1);
        Privilege p2 = new Privilege("Planning - Book step/experiment", "Ability to book a step or an experiment");
        privilegeRepository.save(p2);
        Privilege p3 = new Privilege("Planning - Delete step/experiment own","Ability to delete your own step / experiment");
        privilegeRepository.save(p3);
        Privilege p4 = new Privilege("Planning - Delete step/experiment own/promotor","Ability to delete your own or your promoting students' step / experiment");
        privilegeRepository.save(p4);
        Privilege p5 = new Privilege("Planning - Delete step/experiment all","Ability to delete every step / experiment");
        privilegeRepository.save(p5);
        Privilege p6 = new Privilege("Planning - Adjust step/experiment own","Ability to edit your own step / experiment");
        privilegeRepository.save(p6);
        Privilege p7 = new Privilege("Planning - Adjust step/experiment own/promotor","Ability to edit your own or your promoting students' step / experiment");
        privilegeRepository.save(p7);
        Privilege p8 = new Privilege("Planning - Adjust step/experiment all","Ability to delete every step / experiment");
        privilegeRepository.save(p8);
        Privilege p9 = new Privilege("Planning - Make new step","Ability to create a new kind of step");
        privilegeRepository.save(p9);
        Privilege p10 = new Privilege("Planning - Make new experiment","Ability to create a new kind of experiment" );
        privilegeRepository.save(p10);
        Privilege p11 = new Privilege("Planning - Start within office hours","Ability to only book within office hours");
        privilegeRepository.save(p11);
        Privilege p12 = new Privilege("Planning - Start outside office hours", "Ability to book inside or outside of office hours");
        privilegeRepository.save(p12);
        Privilege p13 = new Privilege("Planning - Overview","Ability to view the planning calendar");
        privilegeRepository.save(p13);
        Privilege p14 = new Privilege("Stock - Aggregates + Bitumen Read only - Basic","Ability to read basic info of Aggregates & bitumen");
        privilegeRepository.save(p14);
        Privilege p15 = new Privilege("Stock - Aggregates + Bitumen Read only - Advanced","Ability to read advanced info of Aggregates & bitumen");
        ...
        Privilege p19 = new Privilege("User Management", "Ability to view user management");
        privilegeRepository.save(p19);
        Privilege p20 = new Privilege("Database - Read only - Basic","Ability to read basic info of the database");
        privilegeRepository.save(p20);
        Privilege p21 = new Privilege("Database - Modify - Advanced","Ability to read and edit advanced info of the database");
        privilegeRepository.save(p21);
        Privilege p22 = new Privilege("Database - Modify - All","Ability to read and edit all info of the database");
        privilegeRepository.save(p22);
        Privilege p23 = new Privilege("Reports - Modify - Advanced","Ability to read and edit advanced info of the reports");
        privilegeRepository.save(p23);
        Privilege p24 = new Privilege("Reports - Modify - All","Ability to read and edit all info of the reports");
        privilegeRepository.save(p24);
        Privilege p25 = new Privilege("Device - Read only - Basic","Ability to read basic info of devices");
        privilegeRepository.save(p25);
        Privilege p26 = new Privilege("Device - Modify - All","Ability to read and edit all info of devices");
        privilegeRepository.save(p26);
        Privilege p27 = new Privilege("Console Access","Ability to view console");
        privilegeRepository.save(p27);
        Privilege p28 = new Privilege("Statistics Access","Ability to view statistics");
